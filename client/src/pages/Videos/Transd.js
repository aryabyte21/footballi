...
function Transd() {
  ...
  return (
    <>
      ...
      <SectionTitle>Team Transition To Attack</SectionTitle>
      <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        {v &&
          v
            .filter((n) => n.type === "team transition attack")
            .map((m) => (
              <div key={m.id}>
                <Card>
      ...
      <SectionTitle>Oppponent Transition To Attack</SectionTitle>
      <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        {v &&
          v
            .filter((n) => n.type === "opponent transition attack")
            .map((m) => (
              <div key={m.id}>
                <Card>
                  <a href="" class="block overflow-hidden rounded-2xl">
      ...
      <SectionTitle>Team Transition To Defence</SectionTitle>
      <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        {v &&
          v
            .filter((n) => n.type === "team transition defence")
            .map((m) => (
              <div key={m.id}>
                <Card>
                  <a href="" class="block overflow-hidden rounded-2xl">
      ...
      <SectionTitle>Oppponent Transition To Defence</SectionTitle>
      <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        {v &&
          v
            .filter((n) => n.type === "opponent transition defence")
            .map((m) => (
              <div key={m.id}>
                <Card>
                  <a href="" class="block overflow-hidden rounded-2xl">
